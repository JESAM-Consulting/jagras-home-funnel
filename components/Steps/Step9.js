...
export default function Step9() {
  ...
  const config = {
    headers: {
      "X-API-Account": "64791345",
      "X-API-Key":
        "m5I8c3aW5k5MhbsImtpZCI6ImpTMVhvMU9XAwhjkds898YndHTmd2UU8DAwMDAiLCJpc3MiOiJodHRwb3dzLm85MjC0wMD1NiGpfNTJ2YnIqwTmgsdgx3425OiJSUzIRGpfyVn.eyJhdWQiOiIwMDAwMDpNYyJ9AwNkZ5ldCdsIng1dCI6ImpTMVhvMU9XRdHldCGciqqTAwMDAtYzAwMMy0wMDAwLd2UU8yqnpNYy",
    },
  };
  ...
  const onSubmit = async (data) => {
    ...
    const sendData = {
      ...
      leadherkunft: "http://jagrashome.solar-pvcheck.de",
